...
var bsNearby = (bsBasis != null ? this.getThisModelAtoms () : hasRange && !haveFixed ?  new JU.BS () : this.ms.getAtomsWithinRadius (rangeFixed, bsSelected, true, null, null));
...
function (units, isAntialiased, retPixels) {
...
var af = (!this.tm.perspectiveDepth && isAntialiased ? 2 : 1);
var f = (this.tm.perspectiveDepth ? 1 / this.tm.getPerspectiveFactor ((this.tm.getCameraDepth () - 0.5) * this.getScreenDim ()) : 1) / af;
var m = 0;
var p = 0;
var e = 0;
var mp = 0;
