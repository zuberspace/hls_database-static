...
Clazz_load (null, "JM.Text", ["java.lang.Float", "JU.PT", "J.shape.Shape", "JU.C", "$.Font", "JV.JC"], function () {
...
var retPixels =  Clazz_newIntArray (1, 0);
this.text = this.vwr.getScaleText (this.textUnformatted.substring (6).trim (), this.vwr.antialiased, retPixels);
this.barPixels = retPixels[0] * Clazz_floatToInt (imageFontScaling);
this.recalc ();
...
Clazz_load (["J.shape.Shape", "java.util.Hashtable"], "J.shape.TextShape", ["JU.P3", "$.PT", "JM.Text", "JU.C", "$.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.objects = null;
...
if (this.objects.get (this.scaleObject.target) === this.scaleObject) this.setPropTS ("delete", this.scaleObject, null);
this.currentObject = this.scaleObject;
return;
}}if ("target" === propertyName) {
...
Clazz_load (null, "J.render.TextRenderer", ["java.lang.Float", "JU.P3i", "JM.Text"], function () {
c$ = Clazz_declareType (J.render, "TextRenderer");
c$.render = Clazz_defineMethod (c$, "render", 
function (text, g3d, scalePixelsPerMicron, imageFontScaling, boxXY, temp, pointerColix, pointerWidth, mode) {
...
if (text.barPixels > 0) {
J.render.TextRenderer.renderScale (g3d, text, temp, isAntialiased);
}} else {
...
return true;
}, "JM.Text,J.api.JmolRendererInterface,~N,~N,~A,~A,~N,~N,~N");
c$.renderScale = Clazz_defineMethod (c$, "renderScale", 
 function (g3d, text, temp, isAntialiased) {
var z = text.z;
var ia = (isAntialiased ? 2 : 1);
for (var i = (ia == 2 ? 3 : 1); i > 0; i -= 1) {
var x1 = Clazz_floatToInt (temp[0]) - text.barPixels - i - ia * 2;
var x2 = Clazz_floatToInt (temp[0]) - i - ia * 2;
var h = Clazz_doubleToInt (text.lineHeight / 4);
var y = Clazz_floatToInt (temp[1]) - h - i;
var sA = JU.P3i.new3 (x1, y, z);
var sB = JU.P3i.new3 (x2, y, z);
...
}, "J.api.JmolRendererInterface,JM.Text,~A,~B");
...
J.render.TextRenderer.render (text, this.g3d, this.scalePixelsPerMicron, this.imageFontScaling, this.boxXY, this.xy, pointerColix, (this.doPointer == 0 ? 0 : this.vwr.getInt (553648147)), this.mode);
...
}if (J.render.TextRenderer.render (t, this.g3d, this.sppm, this.imageFontScaling, null, this.xy, 0, 0, alias) && t.valign == 1 && t.align == 12) this.vwr.noFrankEcho = false;
...
text.setText (label);
J.render.TextRenderer.render (text, this.g3d, 0, antialias ? 2 : 1, null, this.tempXY, 0, 0, 0);
return true;
});
